...
def add_publication(db, name, doi, bibcode, description):
    """
    Consider making Bibcode or DOI the only input and the rest get autogenerated

    :param db:
    :param name: First four digits of author name + 2 digit year
    :param doi:
    :param bibcode:
    :param description:
    :return:
