...
dataset_info = {
    ...
    # 'flux_unit': 'W/cm^2/microns',
    # 'bandpass': 'nir',
    # 'aperture': '0.380 arcsec' ,
    # "obs_location": 'Mauna Kea',
    # 'telescope': 'Keck',
    # 'instrument': 'NIRSPEC',
...
NIRSPEC_spectrum_info = {
    # 'wavelength_unit': 'micron', not used. Should be in spectrum loader
    # 'flux_unit': 'W/cm^2/microns', not used. Should be in spectrum loader.
    'bandpass': 'nir',
    'aperture': '0.380 arcsec',
    "observatory": 'keck',
    'telescope': 'Keck',
